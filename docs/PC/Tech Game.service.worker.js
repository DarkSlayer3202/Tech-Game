...
const CACHE_NAME = "Tech Game-cache";
const OFFLINE_URL = "Tech Game.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["Tech Game.html","Tech Game.js","Tech Game.wasm","Tech Game.pck","Tech Game.offline.html","Tech Game.icon.png","Tech Game.apple-touch-icon.png"];
